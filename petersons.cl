...
static void petersons(__global atomic_int* levels, __global atomic_int* last_to_enter, __global atomic_int* var, int id, int N) {
...
__kernel void litmus_test(__global atomic_int* levels, __global atomic_int* last_to_enter, __global atomic_int* var, __global int* paramsBuffer) {
